...
import doan.thymeleaf.demo.domain.Employee;
...
public class HomeController {
	...
	private List<Artist> getResults() {
		...
		results.add(new Artist("Mariah", "Carrey",
		...
		results.add(new Artist("Elvis", "Presley",
		...
		results.add(new Artist("John", "Lennon",
				Arrays.asList("John Lennon", "Imagine", "Some Time in New York City", "Mind Games", "Walls and Bridges",
						"Rock 'n' Roll"),
